...
a8 <- ggplot(data = Base, 
  ...
  theme_pander()+
  theme(plot.title = element_text(hjust = 0.5, face = "bold", family = "serif", size = 16), axis.title.x = element_text(face = "bold.italic", family = "serif", size = 12), axis.title.y = element_text(face = "bold.italic", family = "serif", size = 12), axis.text = element_text(face = "italic", family = "serif", size = 12))
```
